<x-app-layout>
    <div class="min-h-screen bg-gradient-to-b from-gray-50 to-white mb-[100px]">
        <!-- Header -->
                ...
                <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                    <div>
                        <nav class="flex items-center gap-2 text-sm text-blue-100 mb-3">
                            <a href="{{ route('user.reports') }}" class="hover:text-white transition-colors">Pengaduan Saya</a>
